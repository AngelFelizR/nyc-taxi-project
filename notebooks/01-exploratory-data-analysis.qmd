...
3. Downsampling the data to **10,000,000 rows** to solve memory limitation problems, but keeping a **representative sample** of the population.
...
![Green and Yellow Zones from : https://www.new-york-city-travel-tips.com/green-cab-new-york-boro-taxi/](assets/01-Green-Yellow-Zones.png)
