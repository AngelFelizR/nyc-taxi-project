...
1. Splitting variables in process input related and output related variables.
2. Examining the distribution of each input related variables
3. Defining the target variable
4. Examining the distribution of target related variables
5. Exploring the distribution of target variable
6. Taking a subset of the data to fit in RAM
7. Transforming the data for modeling
8. Imputing missing values
9. 
10. Defining the main characteristics of high paying trips
11. Defining high correlated features
